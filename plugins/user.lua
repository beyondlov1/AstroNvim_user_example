return {
    ...
    config = function ()
      ...
      vim.keymap.set({ "n", "v" }, "bb", "<cmd>BookmarksMarkSimple<cr>", { desc = "Mark current line into active BookmarkList." })
      vim.keymap.set({ "n", "v" }, "bl", "<cmd>BookmarksGoto<cr>", { desc = "Go to bookmark at current active BookmarkList" })
